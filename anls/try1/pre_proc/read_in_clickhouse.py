...
# client.execute('insert into logs values', [date(2010,10,10), "kill", "me"])
# client.execute('insert into logs values', [datetime.2010-10-10, "kill", "me"])


# i think the interface for dates is broken
