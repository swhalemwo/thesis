...
# 
cite:Murphy_2004_concepts, ~other source (Rips et al)~ find that verifying the statement 'a dog is an animal' is faster than the verifying the statement 'a dog is a mammal'. 
# 
...
*** is classical view part of Habermaasian colonization? 


*** cite:Steyvers_2005_structure: The Large‐Scale Structure of Semantic Networks: Statistical Analyses and a Model of Semantic Growth
...
would have to read so much more cognitive science stuff -> i'm f.u.c.k.e.d
