...
# 
According to prototype theory, concepts are generalized abstractions of features, 
# 
A typical fruit might therefore be seen an edible plant that is sweet, has bright colors and is approximately hand-sized. 
# 
However, it is obvious that none of these features are not a simply a unstructured list. 
# 
The color of a typical fruit can be red or yellow, but less easily both at the same time. 
#
...
# 
This notion of typical values can be captured more precisely through the concept of a /probability distribution function/, which specifies the typical probability for each position on a slot. 
# 
